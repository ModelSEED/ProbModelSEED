...
function ProbModelSEED(url, auth, auth_cb) {
    ...
    this.print_model_stats = function (input, _callback, _errorCallback) {
    return json_call_ajax("ProbModelSEED.print_model_stats",
        [input], 1, _callback, _errorCallback);
};

    this.print_model_stats_async = function (input, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("ProbModelSEED.print_model_stats", [input], 1, _callback, _error_callback);
    };
