...
our %return_counts = (
        ...
        'edit_model' => 1,
        'get_feature' => 1,
        'save_feature_function' => 0,
        'compare_regions' => 1,
        'plant_annotation_overview' => 1,
        'create_genome_from_shock' => 1,
        'plant_pipeline' => 1,
        'annotate_plant_genome' => 1,
        'create_featurevalues_from_shock' => 1,
...
our %method_authentication = (
        ...
        'copy_model' => 'required',
        'copy_genome' => 'required',
        'list_model_edits' => 'required',
        'edit_model' => 'required',
        'get_feature' => 'required',
        'save_feature_function' => 'required',
        'compare_regions' => 'required',
        'plant_annotation_overview' => 'required',
        'create_genome_from_shock' => 'required',
        'plant_pipeline' => 'required',
        'annotate_plant_genome' => 'required',
        'create_featurevalues_from_shock' => 'required',
...
sub call_method {
    ...
    my $ctx = Bio::ModelSEED::ProbModelSEED::ServiceContext->new(client_ip => $self->getIPAddress());
    $ctx->module($modname);
    $ctx->method($method);
...
{
    # Service ProbModelSEED requires authentication.
	...
	{
	    $self->exception('PerlError', "Authentication required for ProbModelSEED but no authentication header was passed");
	}
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service ProbModelSEED.");
    }
