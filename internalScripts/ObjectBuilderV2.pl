...
my $subobj = {};
my $specobjects = {};
#my $speclist = ["Template.spec","Ontology.spec","Biochem.spec","Genome.spec","Phenotypes.spec","ProbabilisticAnnotation.spec","Regulation.spec","Expression.spec","GenomeComparison.spec"];
my $speclist = ["Template.spec"];
...
foreach my $name (keys(%{$allobjects})) {
	...
	if (!-d "/Users/chenry/code/ProbModelSEED/lib/Bio/KBase/ObjectAPI/".$module."/DB/") {
		File::Path::mkpath ("/Users/chenry/code/ProbModelSEED/lib/Bio/KBase/ObjectAPI/".$module."/DB/");
	}
	Bio::KBase::ObjectAPI::utilities::PRINTFILE("/Users/chenry/code/ProbModelSEED/lib/Bio/KBase/ObjectAPI/".$module."/DB/".$name.".pm",$output);
	if (!-e "/Users/chenry/code/ProbModelSEED/lib/Bio/KBase/ObjectAPI/".$module."/".$name.".pm") {
		my $oldobject = $name;
		...
		Bio::KBase::ObjectAPI::utilities::PRINTFILE("/Users/chenry/code/ProbModelSEED/lib/Bio/KBase/ObjectAPI/".$module."/".$name.".pm",$output);
	}
}
